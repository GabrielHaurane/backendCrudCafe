...
import { borrarProducto, crearProducto, leerPrueba, listarProductos, obtenerProductos } from "../controllers/producto.controllers.js";
...
productoRouter.route('/productos/:id').get(obtenerProductos).delete(borrarProducto)
